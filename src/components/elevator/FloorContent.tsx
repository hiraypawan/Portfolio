...
export default function FloorContent({ floorData }: FloorContentProps) {
  return (
    <div className="flex items-center justify-center min-h-screen p-8 pt-20 pb-32">
      <motion.div
      ...
      >
        {/* Main Content Card */}
        <motion.div
          className="bg-black/80 backdrop-blur-sm border-2 rounded-2xl p-8 shadow-2xl"
          style={{
          ...
          >
            {floorData.highlights.map((highlight, index) => {
              ...
              return (
                <motion.div
                  key={highlight.text}
                  className="flex items-center space-x-3 bg-gray-900/60 rounded-lg p-3 border"
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {floorData.keyAchievements.map((achievement, index) => (
                <motion.div
                  key={index}
                  className="flex items-start space-x-3 p-4 bg-gray-900/40 rounded-lg border"
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {floorData.technologies.map((tech, index) => (
                <motion.span
                  key={tech}
                  className="px-4 py-2 bg-gray-900/60 rounded-full text-sm font-medium border"
                  style={{ 
                  ...
                  whileHover={{
                    scale: 1.1,
                    borderColor: floorData.theme.accent + '80',
                    boxShadow: `0 0 20px ${floorData.theme.accent}30`
                  }}
