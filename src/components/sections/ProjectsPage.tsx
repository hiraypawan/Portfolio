...
export default function ProjectsPage() {
  return (
    <div className="relative w-full h-full bg-gradient-to-br from-slate-900 via-red-900/30 to-slate-900">
      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-8 py-4 sm:py-6 min-h-screen overflow-y-visible scrollable-content mobile-scroll ios-scroll-fix scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent touch-scroll">
        {/* Header */}
        <motion.div
