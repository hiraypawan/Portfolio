        ...
        
          ...
          <div className="mb-3">
            ...
            <textarea
              ...
              onChange={handleChange}
              required
              className="w-full px-3 py-1 bg-transparent border border-gray-300 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-blue-500 h-20 text-sm"
            />
          </div>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="w-full px-4 py-2 bg-gradient-to-r from-teal-500 to-blue-600 text-white font-semibold rounded-lg hover:from-teal-600 hover:to-blue-700 transition-all duration-300 shadow-lg text-sm"
          >
            Send Message
          </motion.button>
        </motion.form>
        ...
        >
          <div className="flex flex-row items-center justify-center gap-2">
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="flex items-center px-3 py-2 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-lg transition-all duration-300 shadow-lg text-xs"
            >
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="flex items-center px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-all duration-300 shadow-lg text-xs"
            >
              <svg className="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
