...
export default function StoryPage() {
  return (
    <div className="relative h-full bg-gradient-to-br from-slate-900 via-indigo-900 to-slate-900 overflow-hidden">
      ...
      <div className="flex flex-col h-full z-10 relative px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12 overflow-y-auto md:overflow-visible scrollbar-thin md:scrollbar-none scrollbar-thumb-white/20 scrollbar-track-transparent smooth-scroll">
        {/* Header */}
        <motion.div
